...
public class ContaBanco {
    ...
    public void fecharConta(){
        if (this.getSaldo() >0){
            System.out.println("A conta de "+ this.getDono() +" possui saldo positivo e portanto não pode ser fechada");
        } else if (this.getSaldo() <0){
            System.out.println("A conta de " + getDono() + " possui saldo negativo e portanto não pode ser fechada");
        } else{
    ...
    public void depositar(float v){
        if (this.getStatus()){
            ...
            System.out.println("Impossível depositar. Conta de " + this.getDono() + "está fechada");
        }
